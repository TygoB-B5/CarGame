...
namespace Core
{
	...
	{
		glm::vec4 centeralize = { 500, 500, 0, 0 };
		glm::vec4 p1 = centeralize - m_ViewProjectionMatrix * glm::vec4(point1.x, point1.y, point1.z, -1);
		glm::vec4 p2 = centeralize - m_ViewProjectionMatrix * glm::vec4(point2.x, point2.y, point2.z, -1);
		glm::vec4 p3 = centeralize - m_ViewProjectionMatrix * glm::vec4(point3.x, point3.y, point3.z, -1);
		glm::vec4 p4 = centeralize - m_ViewProjectionMatrix * glm::vec4(point4.x, point4.y, point4.z, -1);
